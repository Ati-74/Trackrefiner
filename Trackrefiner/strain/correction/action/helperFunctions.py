...
def calc_neighbors_dir_motion(df, source_bac, neighbor_df, center_coordinate_columns):
        ...
        if neighbor_bac_in_next_time_step.shape[0] > 0:
            direction_of_motion = \
                calculate_trajectory_direction(
                    np.array([neighbor_bac[center_coordinate_columns['x']],
                              neighbor_bac[center_coordinate_columns['y']]]),
                    np.array([neighbor_bac_in_next_time_step.iloc[0][center_coordinate_columns['x']],
                              neighbor_bac_in_next_time_step.iloc[0][center_coordinate_columns['y']]]))
            ...
            for daughter_ndx, daughter_bac in neighbor_bac_daughters_in_next_time_step.iterrows():
                direction_of_motion = \
                    calculate_trajectory_direction(
                        np.array([neighbor_bac[center_coordinate_columns['x']],
                                  neighbor_bac[center_coordinate_columns['y']]]),
                        np.array([daughter_bac[center_coordinate_columns['x']],
                                  daughter_bac[center_coordinate_columns['y']]]))
...
def adding_features_to_each_timestep_except_first(dataframe, bac_indx_in_list, bac_indx_in_df, bacterium_status,
    ...
    direction_of_motion = \
        calculate_trajectory_direction_angle(
            np.array([dataframe.iloc[bacterium_status['lifeHistoryIndex'][index_prev_stage_life]][center_coordinate_columns['x']],
    ...
    center_movement = \
        np.sqrt((dataframe.iloc[bac_indx_in_df][center_coordinate_columns['x']] -
                 dataframe.iloc[bacterium_status['lifeHistoryIndex'][index_prev_stage_life]][
                     center_coordinate_columns['x']]) ** 2 +
                (dataframe.iloc[bac_indx_in_df][center_coordinate_columns['y']] -
                 dataframe.iloc[bacterium_status['lifeHistoryIndex'][index_prev_stage_life]][
                     center_coordinate_columns['y']]) ** 2)

    prev_bacterium_endpoints = find_vertex(
        [dataframe.iloc[bacterium_status['lifeHistoryIndex'][index_prev_stage_life]][center_coordinate_columns['x']],
         dataframe.iloc[bacterium_status['lifeHistoryIndex'][index_prev_stage_life]][center_coordinate_columns['y']]],
        dataframe.iloc[bacterium_status['lifeHistoryIndex'][index_prev_stage_life]][
    ...
    current_bacterium_endpoints = find_vertex(
        [dataframe.iloc[bac_indx_in_df][center_coordinate_columns['x']],
         dataframe.iloc[bac_indx_in_df][center_coordinate_columns['y']]],
...
def adding_features_only_for_last_time_step(dataframe, last_bacterium_in_life_history, bacterium_status,
    ...
    if bacterium_status['division_occ'] and not bacterium_status['bad_division_occ']:
        ...
        daughter1_endpoints = find_vertex([daughters_df[center_coordinate_columns['x']].values.tolist()[0],
                                           daughters_df[center_coordinate_columns['y']].values.tolist()[0]],
                                          daughters_df["AreaShape_MajorAxisLength"].values.tolist()[0],
                                          daughters_df["AreaShape_Orientation"].values.tolist()[0])

        daughter2_endpoints = find_vertex([daughters_df[center_coordinate_columns['x']].values.tolist()[1],
                                           daughters_df[center_coordinate_columns['y']].values.tolist()[1]],
...
def calc_distance_between_daughters(dataframe, d1_ndx, d2_ndx, center_coordinate_columns):

    daughter1 = dataframe.iloc[d1_ndx]
    daughter2 = dataframe.iloc[d2_ndx]

    daughter1_endpoints = \
        find_vertex([daughter1[center_coordinate_columns['x']], daughter1[center_coordinate_columns['y']]],
                    daughter1["AreaShape_MajorAxisLength"], daughter1["AreaShape_Orientation"])

    daughter2_endpoints = \
        find_vertex([daughter2[center_coordinate_columns['x']], daughter2[center_coordinate_columns['y']]],
