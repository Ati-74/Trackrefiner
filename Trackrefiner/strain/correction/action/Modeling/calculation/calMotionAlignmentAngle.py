...
def calc_MotionAlignmentAngle(df, neighbor_df, center_coordinate_columns, selected_rows=None, col_target=None,
    ...
    source_bac_neighbors = \
        selected_rows.merge(neighbor_df, left_on=['ImageNumber' + col_source, 'ObjectNumber' + col_source],
    ...
    source_bac_neighbors_info = \
        source_bac_neighbors.merge(temp_df, left_on=['Second Image Number', 'Second Object Number'],
