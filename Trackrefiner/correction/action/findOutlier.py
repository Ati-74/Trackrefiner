...
def detect_length_change_ratio_outliers(df):
    ...
    :param pandas.DataFrame df:
        DataFrame containing the column "LengthChangeRatio" for analysis.
...
def detect_daughter_to_mother_length_outliers(df):
    ...
    :param pandas.DataFrame df:
        DataFrame containing "daughter_length_to_mother" and "max_daughter_len_to_mother" columns.
...
def calculate_max_daughter_to_mother_boundary(df):
    ...
    :param pandas.DataFrame df:
        DataFrame containing the column "max_daughter_len_to_mother".
...
def calculate_sum_daughter_to_mother_len_boundary(df):
    ...
    :param pandas.DataFrame df:
        DataFrame containing the column "daughter_length_to_mother".
...
def calculate_length_change_ratio_boundary(df):
    ...
    :param pandas.DataFrame df:
        DataFrame containing the column "LengthChangeRatio".
