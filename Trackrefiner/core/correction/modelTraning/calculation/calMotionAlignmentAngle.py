from Trackrefiner.core.correction.action.helper import calc_normalized_angle_between_motion_for_df
...
def calc_motion_alignment_angle_ml(df, neighbor_df, center_coord_cols, selected_rows=None, col_target=None,
    ...
    **Returns**:
    ...
    daughters_idx = ~ df['Total_Daughter_Mother_Length_Ratio'].isna()

    temp_df.loc[daughters_idx, ['source_target_TrajectoryX', 'source_target_TrajectoryY']] = \
        df.loc[daughters_idx, ['Daughter_Avg_TrajectoryX', 'Daughter_Avg_TrajectoryY']].values
