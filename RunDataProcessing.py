...
if __name__ == "__main__":
    ...
    button_browse_file = Button(top,
                                text="CellProfiler tracking file",
                                command=browse_files_func)
    ...
    button_browse_directory = Button(top,
                                     text="Output directory",
                                     command=browse_directory_func)
    ...
    # continuation
    continuation_um_per_pixel_lable = Label(top, text="um")
    continuation_um_per_pixel_lable.pack(side=LEFT)
    continuation_um_per_pixel_lable.place(x=330, y=200)
    continuation_um_per_pixel_lable = Entry(top)
