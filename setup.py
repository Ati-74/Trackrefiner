...
setup(name='TrackRefiner',
      ...
      install_requires=['numpy', 'scipy', 'pandas', 'scikit-learn', 'matplotlib', 'opencv-python', 'scikit-image'],
      setup_requires=['numpy', 'scipy', 'pandas', 'scikit-learn', 'matplotlib', 'opencv-python', 'scikit-image'],
