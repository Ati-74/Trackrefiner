...
def ElongationProximity(interval_time,time_steps,all_bac_row_index,object_index,object_lable,length,Parent_index,Parent_time_step,marker2,x_location,y_location):
